...
const OfficeIcon = () => (
  <svg aria-hidden="true" class="icon" role="img" viewBox="0 0 16 16">
...
const NpmIcon = () => (
  <svg aria-hidden="true" class="icon" role="img" viewBox="0 0 27.23 27.23">
    <rect fill="#333" width="27.23" height="27.23" rx="2"></rect>
    <polygon
      fill="#fff"
