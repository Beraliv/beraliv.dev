...
![Example of DeepReadonly use](./step1-example-of-use.png)
...
![Readonly solution](./step3-readonly-solution.png)
...
![Example of recursive conditional types](./step2-example-of-recursive-conditional-types.png)
...
![All possible keys for an object type](./step5-property-key.png)
