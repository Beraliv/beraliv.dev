...
Since [TypeScript 4.2](https://devblogs.microsoft.com/typescript/announcing-typescript-4-2/) we can use rest elements not only at the very last position of a tuple type:
