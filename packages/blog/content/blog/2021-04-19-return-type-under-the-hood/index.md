...
![Example of ReturnType use](./step1-example-of-use.png)
...
![Example of conditional type](./step2-example-of-conditional-type.png)

For functions we need to have as general type as possible to cover all types of functions:

![Find a general function](./step3-find-any-function.png)
