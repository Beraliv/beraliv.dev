...
date: "2021-03-26"
description: Not a long time ago I discovered type-challenges for myself.
...
![Example of Get debugging](./get-usage-example.png)
...
If you want to learn TypeScript concepts first, please take a look at the [Summary&nbsp;⚓️](https://blog.beraliv.dev/2021-03-26-typed-get/#summary)
...
![Debugging tuples](./debug-get-with-array-for-arrays-v1-for-tuples.png)
...
![Debugging tuples](./debug-get-with-array-for-arrays-v2-for-tuples.png)
...
![Example of a tuple](./tuples.png)

![Example of variadic tuple types](./variadic-tuple-types.png)
