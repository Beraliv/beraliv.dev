...
![Example of Get debugging](/typed-get/get-usage-example.png)
...
If you want to learn TypeScript concepts first, please take a look at the Summary below

<!-- TODO: fix MD [Summary&nbsp;⚓️](/2021-03-26-typed-get/#summary) -->
...
![Path transforms a string into keys, version 1](/typed-get/path-v1.png)
...
![Path transforms a string into keys, final version](/typed-get/path-v2.png)
...
![GetWithArray for objects, version 1](/typed-get/get-with-array-v1.png)
...
![GetWithArray for objects, version 2](/typed-get/get-with-array-v2.png)
