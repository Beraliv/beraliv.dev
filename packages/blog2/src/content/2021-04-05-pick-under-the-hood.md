...
![Example of Mapped Types](/pick-under-the-hood/step2-mapped-types.png)
...
![Iteration over Keys](/pick-under-the-hood/step3-add-keys.png)
...
![Solution](/pick-under-the-hood/step4-solution.png)
